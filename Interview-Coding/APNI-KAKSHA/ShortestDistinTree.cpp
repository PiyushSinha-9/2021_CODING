//Find LCA return (d1+d2)   d1 dist b/w LCA and p1 and d2 is dist b/w LCA and p2
...
signed main() {
    ...
    cout<<"preorder - : ";preorder(bt);br;
    cout<<"postorder - : ";postorder(bt);br;
    cout<<"inorder - : ";inorder(bt);br;
